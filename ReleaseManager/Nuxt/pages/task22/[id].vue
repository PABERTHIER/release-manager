<template>
  <div class="task22-page">
    ...
    <div class="infos">
      ...
      <div class="text">
        <div v-t="'pages.task22.info1'" class="info1" />
      </div>
    </div>
    <div v-if="isFunkyModeEnabled" class="pictures-container">
      <div class="picture">
        <NuxtPicture format="gif" src="gif/minions-huge-party.gif" :width="250" :height="250" />
      </div>
      <div class="picture">
        <NuxtPicture format="gif" src="gif/song-celebration.gif" :width="250" :height="250" />
      </div>
      <div class="picture">
        <NuxtPicture format="gif" src="gif/cheering-minions-party.gif" :width="250" :height="250" />
      </div>
      <div class="picture">
        <NuxtPicture format="gif" src="gif/dance-minion.gif" :width="250" :height="250" />
      </div>
      <div class="picture">
        <NuxtPicture format="gif" src="gif/disco-minions.gif" :width="250" :height="250" />
      </div>
    </div>
  </div>
</template>
